...
class Cru2TrackletTranslator
{
  ...
  enum CRUSate { CRUStateHalfCRUHeader,
                 ...
                 CRUStateDigitMCMHeader,
                 CRUStateDigitMCMData,
                 CRUStatePadding };

 public:
  Cru2TrackletTranslator() = default;
  ~Cru2TrackletTranslator() = default;
  // Cru2DigitTranslator() = default;
  // ~Cru2DigitTranslator() = default;
  ...
  inline bool run()
  {
    ...
    do {
      ...
      if(o2::raw::RDHUtils::getVersion(mDataPointer) != 6) {
        LOG(info)
                  << "... skipping rdh";
      }
      else
 ...
 protected:
  ...
  DigitHCHeader mCurrentHalfChamber;
  DigitMCMHeader mCurrentDigitMCMHeader;
